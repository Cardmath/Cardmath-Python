...
const SimpleSection = ( {sectionTitle, dasboardButtonLabel, dasboardButtonOnClick, tellerConnectButtonLabel, tellerConnectButtonOnClick} ) => {
    return (
        <div className="surface-ground flex justify-content-between align-items-center bg-surface-ground px-4 py-5 md:px-6 lg:px-8">
            <div className="flex border-bottom-1 surface-border">
                <span className="block text-3xl text-900 mb-4">{sectionTitle}</span>
            </div>

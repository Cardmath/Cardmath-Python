...
const Footer = () => {
    return (
        <div className="surface-ground px-4 py-6 md:px-6 lg:px-8 text-center">
            <img src="logo512.png" alt="Image" height="50" />
            <div className="font-medium text-900 mt-4 mb-3">&copy; 2024 Cardmath, Inc</div>

                            ...
                            <div className="flex flex-wrap p-6">
                                <div className="w-full lg:w-6 mb-4 lg:mb-0">
                                    ...
                                    <p className="line-height-3 m-0 text-gray-400">
                                        We maintain a completely transparent database of credit
                                        cards. Submit feedback and corrections for anything you
                                        see!
                                    </p>
                                </div>
                                <div className="w-full lg:w-6">
                                    <div className="flex flex-wrap border-bottom-1 border-gray-700 pb-3 mb-3">
                                        <div
                                            className="px-0 lg:px-3 py-3 cursor-pointer hover:bg-gray-700 transition-duration-150"
                                            onClick={() => {
                                        ...
                                        >
                                            ...
                                            <p className="text-sm text-gray-400 mt-2 mb-0 line-height-3">
                                                Every single credit card we could find.
                                            </p>
                                        </div>
                                        <div
